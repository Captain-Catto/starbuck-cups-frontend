        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-3 pt-2">
            <button type="button"
              ...
              className={`w-full flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-semibold text-sm md:text-base transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black ${
                product.stockQuantity === 0
                  ? "bg-zinc-700 text-zinc-400 cursor-not-allowed"
                  : "border border-zinc-700 text-zinc-300 hover:text-white hover:border-zinc-500 active:scale-[0.97] cursor-pointer"
              }`}
            >
            ...
            {product.productUrl && (
              <a
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg font-medium text-xs md:text-sm bg-white text-black hover:bg-zinc-100 active:scale-[0.97] transition-all duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
              >
