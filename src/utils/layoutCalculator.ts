...
export const getResponsiveGridClasses = (
  ...
  switch (layout) {
    case "homepage":
      return "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 md:gap-4";

    case "related":
      return "grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 md:gap-4";
